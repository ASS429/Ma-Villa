...
import {
  ...
  Menu, X, Sun, Moon, LogOut, ArrowLeft, BellRing, ScrollText, Banknote, Undo2, Send, Palette, ShoppingBag, Inbox, Mail,
} from 'lucide-react'
...
const ENTREES: Entree[] = [
  ...
  { to: '/admin/remboursements', label: 'Remboursements', Icone: Undo2 },
