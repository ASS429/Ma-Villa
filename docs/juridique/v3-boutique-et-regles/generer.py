# -*- coding: utf-8 -*-
"""Met la note du 22 août au format Word, dans la mise en forme des documents
...
SOURCE = os.path.join(ICI, 'NOTE-AU-JURISTE-v3.md')
CIBLE = os.path.join(ICI, 'NOTE-AU-JURISTE-v3.docx')
...
def convertir():
    ...
    marque = entete.add_run('Ma Villa')
    marque.bold = True
    marque.font.size = Pt(13)
    marque.font.color.rgb = ACCENT

    sous = doc.add_paragraph()
    detail = sous.add_run('Location de villas et vente d’artisanat — Sénégal')
