# -*- coding: utf-8 -*-
"""Met la note du 3 septembre au format Word, dans la mise en forme des documents
...
SOURCE = os.path.join(ICI, 'NOTE-AU-JURISTE-v5.md')
CIBLE = os.path.join(ICI, 'NOTE-AU-JURISTE-v5.docx')
